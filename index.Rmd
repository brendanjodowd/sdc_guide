...
You'll see that the colour varies from dark blue to light blue. There are a few easy ways to choose a different range of colours. The first is using ```scale_fill_distiller```:
...
ggplot() + geom_sf(data = lea_166 , aes(fill=Pop2016)) +
  scale_fill_gradient2(low = "blue", high = "red", mid = "white", midpoint = 35000)
```
