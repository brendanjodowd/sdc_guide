...
Suppose we want to plot a categorical variable, perhaps one based on bands of a continuous variable. 

Probably two ways of doing this, one with a new variable that is factorised, and maybe also using some kind of format over the existing variable. 
